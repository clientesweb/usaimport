...
export default function ProductosPage() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return allProducts.filter((product) => slugify(product.category) === selectedCategory)
  }, [selectedCategory])
            ...
            <div className="flex-1">
              ...
              {filteredProducts.length > 0 ? (
                ...
                <div className="text-center py-12 bg-white rounded-lg shadow-sm">
                  <p className="text-gray-600 mb-4">No hay productos disponibles en esta categoría por el momento.</p>
