      ...
      <nav className="px-4 md:px-8 py-2 border-t border-gray-800">
        <div className="flex items-center justify-between gap-4 md:gap-8">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/" className="text-white hover:text-blue-400 transition font-medium whitespace-nowrap">
              Inicio
            </Link>
          ...
          <div className="hidden md:flex flex-1 max-w-md ml-auto">
            ...
            />
            <Button className="bg-blue-600 hover:bg-blue-700 rounded-r rounded-l-none px-4">
