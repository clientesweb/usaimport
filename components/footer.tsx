        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-sm text-gray-400 text-center md:text-left mb-4">
              Importador directo de productos de calidad premium desde Estados Unidos.
            </p>
            {/* Social Media */}
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <Link href="/preguntas-frecuentes" className="hover:text-blue-400 transition">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-start gap-2 justify-center md:justify-start">
                ...
                <a href="https://wa.me/5491234567890" className="hover:text-blue-400 transition">
                  +54 9 11 2345-6789
                </a>
              </li>
              <li className="flex items-start gap-2 justify-center md:justify-start">
                <Mail className="w-4 h-4 mt-0.5 flex-shrink-0" />
                <a href="mailto:info@usaimport.com.ar" className="hover:text-blue-400 transition">
